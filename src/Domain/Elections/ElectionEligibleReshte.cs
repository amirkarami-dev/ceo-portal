...
/// <remarks>
/// <para>
/// <see cref="ReshteCode"/> is an <b>opaque string</b>, stored exactly as <c>ReshteID</c> arrives from
/// <c>WebS_GetEngineerInfo</c>. There is deliberately no enum and no lookup table: the org's real code
/// list is not this repo's to own, and the client's discipline names do not match it. Adding a
/// discipline is an admin typing a code — never a code change.
/// </para>
/// <para>
