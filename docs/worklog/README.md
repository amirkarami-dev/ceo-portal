...
| 2026-08-19 | [The API's SMS provider set, and what it can actually carry](2026-08-19-election-sms-direct-provider.md) | api | on the branch; **delivery still unwired** |
