...
|---|---|---|---|
| 2026-08-12 | [Two follow-ups cleared, and the widget-count line removed](2026-08-12-analytics-followups.md) | analytics-web + all 8 SPAs | analytics **live**; 7 apps committed, not deployed |
