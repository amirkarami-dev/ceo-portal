...
|---|---|---|---|
| 2026-08-03 | [VMS: the mobile menu, and a drawer bug that was never about the drawer](2026-08-03-vms-mobile-menu.md) | vms / room | built and verified; **not yet deployed** |
