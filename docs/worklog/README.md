...
|---|---|---|---|
| 2026-08-14 | [Renaming a chart label in place, and the two blockers that made it a backend job](2026-08-14-analytics-editable-labels.md) | analytics + api | built and verified locally; **not deployed** |
