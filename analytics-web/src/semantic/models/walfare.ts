  ...
  entities: [
    {
      ...
      fields: [
        ...
        { id: "NationalCode", column: "NationalCode", type: "string", role: "dimension",
          label: { "fa-IR": "کد ملی", "en-US": "National ID" },
          synonyms: ["کد ملی", "شماره ملی", "national id"] },
        { id: "TrackingCode", column: "TrackingCode", type: "string", role: "dimension",
          label: { "fa-IR": "کد رهگیری", "en-US": "Tracking Code" },
          synonyms: ["رهگیری", "کد بلیط"] },
