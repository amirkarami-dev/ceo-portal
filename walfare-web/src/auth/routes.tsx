    ...
    <ScreenShell>
      ...
      >
        ...
        <Typography.Text type="secondary" style={{ display: "block", marginBottom: 32 }}>
          ورود با کد ملی و کد پیامکی — ویژه مهندسین عضو سازمان
        </Typography.Text>
...
/** The engineers' gate: any signed-in account may use the dashboard. */
...
/**
 * The /admin section's gate: authenticated **and** `Administrator`. Signed-in non-admins get the
 * "admin access required" screen in place, so they keep a working logout button.
 */
